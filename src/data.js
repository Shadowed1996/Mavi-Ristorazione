...
export const PAZIENTI_COMUNITA = [
  {
    ...
    dieta: {
      lunedì:    { pranzo: { primo: "Risotto agli asparagi || NO MANTECATO", secondo: "Tacchino freddo", contorno: "Patate al forno" }, cena: { primo: "—", secondo: "—", contorno: "—" } },
  ...
  },
  {
    ...
    dieta: {
      lunedì:    { pranzo: { primo: "Risotto agli asparagi || NO MANTECATO", secondo: "Fusi di pollo al forno", contorno: "Patate al forno" }, cena: { primo: "—", secondo: "—", contorno: "—" } },
  ...
  },
  {
    ...
    dieta: {
      lunedì:    { pranzo: { primo: "Risotto agli asparagi", secondo: "Fusi di pollo al forno", contorno: "Patate al forno" }, cena: { primo: "Penne al pomodoro e basilico", secondo: "Tacchino freddo", contorno: "Carote prezzemolate" } },
      martedì:   { pranzo: { primo: "Pasta al pesto", secondo: "Arrosto di coppa alle erbe", contorno: "Insalata mista" }, cena: { primo: "Pasta zucchine", secondo: "Frittata alle verdure", contorno: "Purè di patate" } },
...
export const ETICHETTE_AZIENDA_DEMO = [
  { id: "ea01", nome: "Anna Ferrari", primo: "Penne al pomodoro e basilico", secondo: "Petto di pollo alla griglia", contorno: "Verdure grigliate" },
  { id: "ea02", nome: "Marco Bassi", primo: "Risotto ai funghi porcini", secondo: "Salmone al forno con erbe", contorno: "Insalata mista" },
  { id: "ea03", nome: "Sara Colombo", primo: "Vellutata di zucca e carote", secondo: "Tofu alla piastra con verdure", contorno: "Fagiolini al vapore" },
  { id: "ea04", nome: "Luca De Santis", primo: "Lasagne alla bolognese", secondo: "Polpette di manzo al sugo", contorno: "Patate al forno" },
  { id: "ea05", nome: "Giulia Moretti", primo: "Insalata di farro e verdure", secondo: "Piatto di formaggi misti", contorno: "Insalata mista" },
  { id: "ea06", nome: "Chiara Vitali", primo: "Penne al pomodoro e basilico", secondo: "Tofu alla piastra con verdure", contorno: "Verdure grigliate" },
  { id: "ea07", nome: "Davide Orlando", primo: "Risotto ai funghi porcini", secondo: "Petto di pollo alla griglia", contorno: "Patate al forno" },
].map((r) => ({
  ...r,
...
export const RESOCONTO_MENSILE = {
  ...
  azienda: {
    dipendenti: DIPENDENTI.map((d) => ({
      ...d,
      dettaglio: [
        { giorno: "1 ago", primo: "Penne al pomodoro e basilico", secondo: "Petto di pollo alla griglia", contorno: "Insalata mista" },
        { giorno: "2 ago", primo: "Risotto ai funghi porcini", secondo: "Salmone al forno con erbe", contorno: "Verdure grigliate" },
        { giorno: "5 ago", primo: "Lasagne alla bolognese", secondo: "Polpette di manzo al sugo", contorno: "Patate al forno" },
        { giorno: "6 ago", primo: "Vellutata di zucca e carote", secondo: "Tofu alla piastra con verdure", contorno: "Fagiolini al vapore" },
        { giorno: "7 ago", primo: "Pasta integrale al pesto", secondo: "Piatto di formaggi misti", contorno: "Insalata mista" },
        { giorno: "8 ago", primo: "Insalata di farro e verdure", secondo: "Petto di pollo alla griglia", contorno: "Verdure grigliate" },
        { giorno: "9 ago", primo: "Risotto ai funghi porcini", secondo: "Salmone al forno con erbe", contorno: "Patate al forno" },
        { giorno: "12 ago", primo: "Penne al pomodoro e basilico", secondo: "Polpette di manzo al sugo", contorno: "Insalata mista" },
        { giorno: "13 ago", primo: "Lasagne alla bolognese", secondo: "Tofu alla piastra con verdure", contorno: "Fagiolini al vapore" },
        { giorno: "14 ago", primo: "—", secondo: "—", contorno: "—" },
        { giorno: "16 ago", primo: "Vellutata di zucca e carote", secondo: "Petto di pollo alla griglia", contorno: "Verdure grigliate" },
        { giorno: "19 ago", primo: "Pasta integrale al pesto", secondo: "Salmone al forno con erbe", contorno: "Patate al forno" },
        { giorno: "20 ago", primo: "Insalata di farro e verdure", secondo: "Piatto di formaggi misti", contorno: "Insalata mista" },
        { giorno: "21 ago", primo: "Risotto ai funghi porcini", secondo: "Polpette di manzo al sugo", contorno: "Verdure grigliate" },
        { giorno: "22 ago", primo: "Penne al pomodoro e basilico", secondo: "Petto di pollo alla griglia", contorno: "Fagiolini al vapore" },
        { giorno: "23 ago", primo: "Lasagne alla bolognese", secondo: "Tofu alla piastra con verdure", contorno: "Patate al forno" },
        { giorno: "26 ago", primo: "Vellutata di zucca e carote", secondo: "Salmone al forno con erbe", contorno: "Insalata mista" },
        { giorno: "27 ago", primo: "Pasta integrale al pesto", secondo: "Piatto di formaggi misti", contorno: "Verdure grigliate" },
        { giorno: "28 ago", primo: "Insalata di farro e verdure", secondo: "Petto di pollo alla griglia", contorno: "Fagiolini al vapore" },
        { giorno: "29 ago", primo: "Risotto ai funghi porcini", secondo: "Polpette di manzo al sugo", contorno: "Patate al forno" },
        { giorno: "30 ago", primo: "Penne al pomodoro e basilico", secondo: "Salmone al forno con erbe", contorno: "Insalata mista" },
      ].slice(0, d.pasti),
    })),
...
export const INGREDIENTI_DIETE = {
  ...
  "Fusi di pollo al forno": { ing: "Fusi di pollo, rosmarino, aglio, olio EVO, patate, sale, pepe", a: [] },
  ...
  "Penne al pomodoro e basilico": { ing: "Pasta di semola, passata di pomodoro, basilico, aglio, olio EVO, sale", a: ["1"] },
  "Petto di pollo alla griglia": { ing: "Petto di pollo, rosmarino, timo, aglio, olio EVO, sale, pepe", a: [] },
  "Tofu alla piastra con verdure": { ing: "Tofu biologico, salsa di soia, zenzero, olio di sesamo, sale", a: ["6"] },
  "Fagiolini al vapore": { ing: "Fagiolini, olio EVO, sale", a: [] },
  "Piselli al tegame": { ing: "Piselli, cipolla, olio EVO, sale, menta", a: [] },
  "Polpette di manzo al sugo": { ing: "Carne bovina e suina, pangrattato, uova, parmigiano, passata di pomodoro, cipolla, olio EVO, sale", a: ["1","3","7"] },
  "Piatto di formaggi misti": { ing: "Selezione di formaggi stagionati e freschi", a: ["7"] },
  "Insalata di farro e verdure": { ing: "Farro perlato, pomodorini, olive, cetrioli, cipolla rossa, olio EVO, basilico, sale", a: ["1"] },
  "Salmone al forno con erbe": { ing: "Filetto di salmone, limone, aneto, olio EVO, pangrattato, sale, pepe", a: ["1","4"] },
