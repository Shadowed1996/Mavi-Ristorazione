...
export const Icone = {
  ...
  righe: (p) => <Svg {...p}><path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01" /></Svg>,
...
export function schedaPdf(id) {
  ...
  const nutrienti = [
    ["Energia", p.kcal + " kcal"], ["Grassi", p.g[0] + " g"], ["di cui acidi grassi saturi", p.g[1] + " g"],
    ["Carboidrati", p.g[2] + " g"], ["di cui zuccheri", p.g[3] + " g"], ["Proteine", p.g[4] + " g"], ["Sale", p.g[5] + " g"],
  ];
